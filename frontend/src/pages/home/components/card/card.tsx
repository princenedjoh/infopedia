    ...
    const [cardText, setCardText] = i.useState([
        {
            ...
            icon : <RiCheckboxMultipleFill color={i.theme.colors2.shades.white} size='30px'/>,
        ...
        },
        {
            ...
            icon : <GiPapers color={i.theme.colors2.shades.white} size='30px'/>,
        ...
        },
        {
            ...
            icon : <HiTrophy color={i.theme.colors2.shades.white} size='30px'/>,
